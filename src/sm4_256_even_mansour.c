...
void sm4_256_encrypt_even_mansour(uint8_t *in,uint8_t *out,uint8_t *key,SM4_KEY *ks) {
    ...
    uint32_t KEY0 = load_u32_be(key, 0);
    uint32_t KEY1 = load_u32_be(key, 1);
    uint32_t KEY2 = load_u32_be(key, 2);
    uint32_t KEY3 = load_u32_be(key, 3);
    /*
...
void sm4_256_decrypt_even_mansour(uint8_t *in,uint8_t *out,uint8_t *key,SM4_KEY *ks) {
    ...
    uint32_t B1 = load_u32_be(in, 1);
    uint32_t B2 = load_u32_be(in, 2);
    uint32_t B3 = load_u32_be(in, 3),tmp;

    uint32_t KEY0 = load_u32_be(key, 3);//Key also needs to be reverse. 
    uint32_t KEY1 = load_u32_be(key, 2);
    uint32_t KEY2 = load_u32_be(key, 1);
    uint32_t KEY3 = load_u32_be(key, 0);
